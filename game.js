...
function load(data) {
    ...
    while (pos < data.length - 1) {
        ...
        for (let ix = 0; ix < 2; ix++) {
            ...
            console.log('insert into ai_fit(variant_id, setup, move, estimate, rd, winner) values(225, \'' + fen + '\', ' + p + ', ' + estimate + ', ' + rd + ', ' + winner * player + ');');
        }
        board[move] = player;
        player = -player;
//      dump(board, SIZE);
